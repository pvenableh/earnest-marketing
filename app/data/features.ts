...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    tagline: 'A context-aware assistant — and a Director mode — that can read and change your whole business.',
...
export const features: Feature[] = [
  // ─────────────────────────  HOME  ─────────────────────────
  {
    ...
    icon: 'i-lucide-zap',
    pillar: 'home',
    desc: 'Open Earnest to a single greeting that tells you exactly what needs you. The Command Center scans tickets, projects, tasks, invoices, channels, social, deals, and goals — then surfaces prioritized actions and urgent items. No AI tokens needed — pure algorithmic intelligence that loads instantly every time.',
    keywords: ['productivity', 'command center', 'task prioritization', 'business dashboard', 'priority actions'],
    benefits: [
      'A daily greeting with prioritized actions across every module',
      'Zero AI tokens — pure algorithmic intelligence, loads instantly',
  ...
  },
  {
    ...
    keywords: ['meeting recording', 'transcription', 'ai recap', 'meeting notes', 'design review'],
    benefits: [
      'Auto-record + auto-transcribe — host joining is all it takes',
      'AI recap with decisions, action items, and follow-up draft',
  ...
  // ─────────────────────────  AI  ─────────────────────────
  {
    name: 'Earnest Assistant',
    slug: 'contextual-ai-sidebar',
    icon: 'i-lucide-message-square-more',
    pillar: 'ai',
    desc: 'Every client, project, invoice, and lead gets its own Earnest assistant, a tap away from anywhere. It sees the entity you are working on and pulls in relevant context — past conversations, open tasks, billing history — with smart prompt suggestions for that record. Save any answer as a note. No tab-switching, no re-explaining.',
    keywords: ['ai sidebar', 'contextual chat', 'entity ai', 'ask earnest', 'ai notes'],
    benefits: [
      'Globally available — open Earnest from any screen',
      'Entity-scoped chats persist across visits',
  ...
  },
  {
    ...
    keywords: ['AI strategy', 'context broker', 'business intelligence', 'token efficiency'],
    benefits: [
